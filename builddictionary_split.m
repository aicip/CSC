function [ Signature, TypeNum, Sc, Tc ] = builddictionary_split( ...
...
Endmember = [   root_pattern_gen(301*(seg-1)+1:301*seg,:), ...
                root_pattern_line(301*(seg-1)+1:301*seg,:), ...
                root_pattern_load(301*(seg-1)+1:301*seg,:)];
